...
export const SLIDE_BACKGROUND_CONTROLS = {
  ...
  layers: [
    ...
    {
      src: "/backgrounds/strawbarry.png",
      steps: [7],
      position: "center center",
      size: "cover",
      maxOpacity: 0.84,
    ...
    {
      src: "/backgrounds/strawberry-banan.png",
      steps: [9],
      position: "center center",
      size: "cover",
      maxOpacity: 0.86,
...
export const TEXT_LAYER_CONTROLS = {
  ...
  malina: {
    ...
    titleFontSize: "var(--sofin-title-size-malina)",
    titleLineHeight: 0.92,
    titleLetterSpacing: "0em",
    titleMaxWidth: "16ch",
    eyebrowFontSize: "11px",
  ...
  scenes: {
    ...
    6: { x: "0px", y: "0px", titleMaxWidth: "14ch" },

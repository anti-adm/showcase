...
export function HomePage() {
  return (
    <main>
      ...
      <LargeStoryPanel panel="categories" image="/images/hero/hero2.jpeg" accentImage="/images/products/yogurt-cherry-270.jpg" secondaryImage="/images/products/yogurt-pineapple-270.jpg" />
